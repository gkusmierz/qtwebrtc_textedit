...
LIBS += -Wl,--start-group
LIBS += $$WEBRTCBUILD/obj/third_party/jsoncpp/libjsoncpp.a
LIBS += $$WEBRTCBUILD/obj/talk/libjingle_peerconnection.a
LIBS += $$WEBRTCBUILD/obj/net/third_party/nss/libcrssl.a
LIBS += $$WEBRTCBUILD/obj/talk/libjingle.a
LIBS += $$WEBRTCBUILD/obj/talk/libjingle_media.a
LIBS += $$WEBRTCBUILD/libyuv.a
LIBS += $$WEBRTCBUILD/obj/third_party/libjpeg_turbo/libjpeg_turbo.a
LIBS += $$WEBRTCBUILD/obj/third_party/usrsctp/libusrsctplib.a
...
LIBS += $$WEBRTCBUILD/obj/third_party/opus/libopus.a
...
LIBS += $$WEBRTCBUILD/obj/third_party/libvpx/libvpx.a
LIBS += $$WEBRTCBUILD/obj/third_party/libvpx/libvpx_asm_offsets_vp8.a
LIBS += $$WEBRTCBUILD/obj/third_party/libvpx/libvpx_intrinsics_mmx.a
LIBS += $$WEBRTCBUILD/obj/third_party/libvpx/libvpx_intrinsics_sse2.a
LIBS += $$WEBRTCBUILD/obj/third_party/libvpx/libvpx_intrinsics_ssse3.a
...
LIBS += $$WEBRTCBUILD/obj/third_party/protobuf/libprotobuf_lite.a
...
LIBS += $$WEBRTCBUILD/obj/third_party/libsrtp/libsrtp.a
LIBS += -Wl,--end-group
LIBS += -lnss3 -lsmime3 -lsoftokn3 -lnssutil3 -lplds4 -lplc4 -lnspr4 -lsqlite3 -ldl -lcrypto -lrt -lexpat -lm -lXext -lX11 
